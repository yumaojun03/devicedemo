...
from devicedemo.objects import base as objects_base
# from devicedemo.service import periodic
# from devicedemo.servicegroup import magnum_service_periodic as servicegroup
